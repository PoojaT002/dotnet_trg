...
namespace DelegateDemo
{
    ...
    internal class Program
    {
        ...
        {
            //PrintNumberDelegat printDelegate = new PrintNumberDelegat(PrintNumber);
            ...
            printNumberDelegate -= DisplayMessage;
            Console.WriteLine(" \n\n Multicast delegate demo after reference of DisplayMessage");
            printNumberDelegate(30000);
            Console.WriteLine( greetDelegate("John"));
            Console.ReadLine();
            }
